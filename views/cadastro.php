...
<div class="bg-light">
    ...
    <section class="container">
      ...
      <div>
        <form class="g-3 needs-validation pt-3" novalidate method="$_POST" action="../models/User.php">
          <div class="col-md-4">
          ...
          <div class="col-md-4 pt-3">
            ...
            <input type="email" class="form-control" name="email" id="validationCustom02" placeholder="Seu email"  required>
            <div class="valid-feedback">
              Tudo ok
            </div>
          </div>
          <div class="col-md-4 pt-3">
            ...
            <div class="input-group has-validation">
              <input type="text" class="form-control" name="cpf" id="validationCustomUsername" aria-describedby="inputGroupPrepend" required>
