      ...
      <div>
        <form class="g-3 needs-validation pt-3" novalidate method="POST" action="../controllers/cadastro.php">
          <div class="col-md-4">
            ...
            <input name="name" type="text" class="form-control" id="validationCustom01" placeholder="Seu Nome" required>
          ...
          <div class="col-md-4 pt-3">
            ...
            <input name="email" type="email" class="form-control" id="validationCustom02" placeholder="Seu email"  required>
            <div class="valid-feedback">
              Tudo ok
            </div>
          </div>
          <div class="col-md-4 pt-3">
            ...
            <div class="input-group has-validation">
              <input name="cpf" type="text" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" required>
